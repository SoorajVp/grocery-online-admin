// pages/admin/AdminManagement.js
...
const AdminManagement = () => {
    ...
    const filteredAdmins = admins.filter((admin) => {
        ...
        const matchesStatus =
            statusFilter === "all" ||
            (statusFilter === "active" && !admin.blocked) ||
            (statusFilter === "blocked" && admin.blocked);
    ...
    const toggleAdminStatus = (id) => {
        setAdmins(
            admins.map((a) =>
                a._id === id ? { ...a, blocked: !a.blocked } : a
            )
        );
    };
    ...
    return (
        <div className="p-6 space-y-3">
            ...
            {/* Admin Table */}
            <AdminTable admins={filteredAdmins} toggleAdminStatus={toggleAdminStatus} />
